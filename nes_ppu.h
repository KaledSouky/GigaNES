...
extern void ppu_scanline(bitmap_t *bmp, int scanline, bool draw_flag, uint32 base_cycles);
extern void ppu_spr0_hit_predict(int scanline, uint32 base_cycles);
...
extern uint8 ppu_get_bg_table(void);
