...
extern int rom_get_region(const char *filename);
...
extern void rom_savesram_async(rominfo_t *rominfo);

extern int sram_dirty;
extern uint32 sram_last_write;
